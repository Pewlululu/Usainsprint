...
import Controller.Manager.CouponSearchController;
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Search by Coupon Name :");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 40, -1, 30));
        ...
        jPanel3.add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 200, -1, 20));
    ...
    public void Searchbt() {
        if (!txtSearchCouponName.getText().equals("")) {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            CouponSearchController csc = new CouponSearchController();
            csc.txtinput = txtSearchCouponName.getText();
            Iterator<Coupon> itr = csc.Search();
            while (itr.hasNext()) {
                Coupon cp = itr.next();
                dtm.addRow(new Object[]{cp.getCouponId(), cp.getCouponName(), cp.getCouponDiscount(), cp.getStartDate(), cp.getEndDate()});
            }
        } else {
            showdata();
        }
    ...
    private void txtCouponNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCouponNameKeyReleased
        ...
        Cnc.CouponName = txtCouponName.getText();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        if (txtSearchCouponName.getText().isEmpty())
            showdata();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        lblCouponId.setText(model.getValueAt(index, 0).toString());
        System.out.println(model.getValueAt(index, 1).toString());
        //String couponName = model.getValueAt(index, 1).toString();
        txtCouponName.setText(model.getValueAt(index, 1).toString());
        //String couponDiscount = model.getValueAt(index, 2).toString();
        txtCouponDiscount.setText(model.getValueAt(index, 2).toString());
