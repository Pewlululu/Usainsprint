...
import Controller.Customer.AddOrdersController;
import Controller.Customer.ConfirmOrderController;
import Controller.Customer.SearchMenuController;
...
import Controller.Customer.ViewMenuController;
...
public class CustomerOrderPage extends javax.swing.JFrame {
    ...
    private void btnConfirmOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmOrderActionPerformed
        ...
        Cfo.Phone = UserPhone;
        Cfo.Quantity = Quan;
        Cfo.allergy = txtAllergies.getText();
    ...
    public void ShowData() {
        ...
        Iterator<FoodItem> itr2 = vmc.getAllFooddata();
        while (itr2.hasNext()) {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        ViewMenuController vmc = new ViewMenuController();
        OrderId = vmc.getId();
        txtOrderId.setText(String.valueOf(vmc.getId()));

        Iterator<FoodItem> itr = vmc.AllCategoryRecords();
        ...
        while (itr.hasNext()) {
            ...
            if (txtSearchByFoodItem.getText().equals("")) {
                ShowData();
            }
        }
    ...
    public void Searchbt() {
        if (!txtSearchByFoodItem.getText().equals("")) {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            SearchMenuController smc = new SearchMenuController();
            smc.txtinput = txtSearchByFoodItem.getText();
            Iterator<FoodItem> itr = smc.Search();
            while (itr.hasNext()) {
                FoodItem cp = itr.next();
                dtm.addRow(new Object[]{cp.getFoodItemName()});
            }
        } else {
            ShowData();
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        AddOrdersController Aoc = new AddOrdersController();
