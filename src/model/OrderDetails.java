...
public class OrderDetails {
    ...
    public static void save(OrderDetails Orderdetail) {
        String query = "insert into OrderDetail(OrderId, FoodItem, FoodQuantity, FoodPrice, OrderDate, TotalPrice) values('" + Orderdetail.getOrderId() + "','" + Orderdetail.getFoodItem() + "','" + Orderdetail.getFoodQuantity() + "'"
                + ",'" + Orderdetail.getFoodPrice() + "','" + Orderdetail.getOrderDate() + "','" + Orderdetail.getTotalPrice() + "')";
